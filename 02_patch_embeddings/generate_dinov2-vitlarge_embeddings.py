...
# Model weights available at: https://huggingface.co/facebook/dinov2-large
...
if __name__ == "__main__":
    ...
    model_load_path = model_base_path+"dinov2_large_model"
    processor_load_path = model_base_path+"dinov2_large_processor"
            ...
            with h5py.File(f, 'r') as h5_file:
                ...
                for i in range(num_parts):
                    ...
                    with torch.no_grad():
                        ...
                        cls_token_batch = last_hidden_state_batch
